...
public class A1V4 extends Configured implements Tool{
	...
	public static class MyReducer extends MapReduceBase
	 ...
	 @Override  
	  public int run(String[] args) throws Exception {  
	    JobConf conf = new JobConf(getConf(), A1V4.class);   
	    conf.setJobName("Median Version4");  
	  ...
	  public static void main(String[] args) throws Exception {   
	    int res = ToolRunner.run(new Configuration(), new A1V4(), args);  
	    System.exit(res);  
	  }  
}
